...
public class LibVLC {
    ...
    public void initAout(int sampleRateInHz, int channels, int samples) {
        ...
        /* Original Code // Changed on 8th Oct 2014
         * mAout.init(sampleRateInHz, channels, samples);
         */
        //TODO: 
        if (sampleRateInHz>44100) mAout.initFivePointOne(sampleRateInHz, channels, samples);
        else mAout.init(sampleRateInHz, channels, samples);
    }
