...
import com.nined.player.model.cling.local.AlbumContainer;
import com.nined.player.model.cling.local.ArtistContainer;
import com.nined.player.model.cling.local.AudioContainer;
import com.nined.player.model.cling.local.ImageContainer;
import com.nined.player.model.cling.local.VideoContainer;
import com.nined.player.model.cling.local.base.CustomContainer;
...
public class ContentDirectoryService extends AbstractContentDirectoryService
{
                               ...
                               SortCriterion[] orderby) throws ContentDirectoryException
    {
        ...
        try
        {
            ...
            if(PrefUtils.getBoolean(ctx, PlayerApi.CONTENTDIRECTORY_VIDEO, true))
            {
            ...
            if(PrefUtils.getBoolean(ctx, PlayerApi.CONTENTDIRECTORY_AUDIO, true))
            {
            ...
            if(PrefUtils.getBoolean(ctx, PlayerApi.CONTENTDIRECTORY_IMAGE, true))
            {
